...
class DriftDetector:
    ...
    def __init__(self, training_data_path="training_table_v1.csv"):
        self.training_data = pd.read_csv(training_data_path)
        self.stats_file = Path("monitoring/training_stats.json")
        self.drift_log = Path("monitoring/drift_alerts.log")
